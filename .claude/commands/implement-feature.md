Implement a given feature plan

If no feature plan is given then provide the user with the latest 3 feature plans under /docs/featurePlans
...
as well as the feature plan doc as well. The commit message should use a 1-line summary at the top,
leave an empty line, and then implementation details via bullet points.